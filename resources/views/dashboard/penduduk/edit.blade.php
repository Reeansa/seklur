...
@section('content')
    <div class="grid grid-cols-12 w-full h-screen">
        ...
        <div class="col-span-9 bg-slate-orange-200 p-5 space-y-20 bg-slate-200">
            ...
            <form class="space-y-5 bg-white rounded-xl" action="{{ route('data-penduduk.update', $data->id) }}"
                method="POST">
                @csrf
                ...
                <div class="p-5 space-y-5">
                    <div>
                        <div class="flex gap-2 items-center w-full justify-between">
                            <p>NIK</p>
                            <input value="{{ $data->nik }}" name="nik" type="number"
                    ...
                    <div>
                        <div class="flex gap-2 items-center w-full justify-between">
                            ...
                            <div class="w-3/4 flex gap-3">
                                <input value="{{ $data->tempat_lahir }}" name="tempat_lahir" type="text"
                                    class="w-1/2 border border-black py-2 px-4">
                                <input value="{{ $data->tanggal_lahir }}" name="tanggal_lahir" type="date"
                                    class="w-1/2 border border-black py-2 px-4">
                            </div>
                        </div>
                        @error('tempat_lahir')
                    ...
                    <div>
                        <div class="flex gap-2 items-center w-full justify-between">
                            <p>Agama</p>
                            <input value="{{ $data->agama }}" name="agama" type="text"
                                class="w-3/4 border border-black py-2 px-4">
                        </div>
                        @error('agama')
                            <p class="text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        <div class="flex gap-2 items-center w-full justify-between">
                            ...
                            <input value="{{ $data->status_perkawinan }}" name="status_perkawinan" type="text"
                                class="w-3/4 border border-black py-2 px-4">
                        </div>
                    ...
                    <div>
                        <div class="flex gap-2 items-center w-full justify-between">
                            <p>Pekerjaan</p>
                            <input value="{{ $data->pekerjaan }}" name="pekerjaan" type="text"
                                class="w-3/4 border border-black py-2 px-4">
                        </div>
                        @error('pekerjaan')
                            <p class="text-red-500">{{ $message }}</p>
