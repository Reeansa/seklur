...
@section('content')
    <div class="flex items-center justify-center h-screen w-full">
        <div class="h-fit w-1/5 rounded-xl bg-white p-10 space-y-5 shadow-lg">
            ...
            <form class="flex flex-col w-full space-y-3" action="" method="post">
                ...
                <a href="{{ route('dashboard') }}"
                    class="w-full py-2 border-[0.5px] border-black bg-[#4DA8CA] text-center">Login</a>
            </form>
        </div>
        <div id="login-modal" class="absolute bg-white w-96 h-96 shadow-lg rounded hidden">
            <div class="flex flex-col items-center gap-28">
                ...
                <div class="text-center">
                    <button class="text-white bg-[#152A75] w-24 h-10 rounded">OK</button>
                </div>
            </div>
        </div>
        <div id="login-modal" class="absolute bg-white w-96 h-96 shadow-lg rounded hidden">
            <div class="flex flex-col items-center gap-28">
                <div class="flex flex-col items-center">
                    ...
                    <h1 class="text-3xl font-semibold">Login Gagal</h1>
                </div>
                <div class="text-center">
                    <button class="text-white bg-[#152A75] w-24 h-10 rounded">OK</button>
                </div>
